...
public class Quickstart {
	...
	*/
    private static String subscription_key = System.getenv("LUIS_SUBSCRIPTION_KEY");
    // You must use the same region as you used to get your LUIS subscription keys. 
	private static String endpoint = System.getenv("LUIS_REGION") + ".api.cognitive.microsoft.com";
	private static EndpointAPI region = EndpointAPI.fromString(endpoint);
	...
	public static void list_applications() {
		LUISAuthoringClient client = LUISAuthoringManager.authenticate(region, subscription_key);
