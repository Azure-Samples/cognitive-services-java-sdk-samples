namespace FaceApiSnapshotSample
{
    ...
    public class Sample
    {
        ...
        /// </summary>
        private const string SourceEastAsiaEndpoint = "https://southcentralus.api.cognitive.microsoft.com/";

        /// <summary>
        /// Source subscription key in East Asia Region.
        /// </summary>
        private const string SourceEastAsiaKey = "";
        ...
        /// </summary>
        private const string TargetWestUSKey = "";

        /// <summary>
        /// Target subscription key related azure subscription ID in West US Region.
        /// </summary>
        private static readonly Guid TargetWestUSAzureSubscriptionId = new Guid("dfdb3164-4098-4867-ba41-d826dba2f587");
