...
namespace FaceIdentify
{
	class Program
	{
		...
		private const string subscriptionKey = "cb2ea73e0f074a0e83e0ee50dc129f4b";
		...
		private const string personGroupID = "jfk_group_12345";
		...
		{
			string id = "85000fc4-997c-470d-b4f1-6f59d3d6cc11";
			CognitiveServicesAccount account = new CognitiveServicesAccount(id);
