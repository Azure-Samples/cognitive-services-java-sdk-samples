...
Prerequisites:
    ...
    Run python file with all images from the root directory: face_person_group
'''
...
# Uncomment the UUID to generate a random ID. Person Group ID must be all lower case.
...
print('Woman ID:', woman.person_id)
# Define man friend
man = face_client.person_group_person.create(person_group_id, "Man")
print('Man ID:', man.person_id)
# Define child friend
child = face_client.person_group_person.create(person_group_id, "Child")
print('Child ID:', child.person_id)
...
while (training_status.status is TrainingStatusType.running 
            or training_status.status is TrainingStatusType.nonstarted):
